...
import { Alert, Anchor, IconButton, LabeledSelect, ProgressRadial, SelectOption, Tab, Table, Tabs, Text, Tile } from "@itwin/itwinui-react";
          ...
          <div className="issue-list-header">
            ...
            <div className="issue-list-filters">
              <div className="filter">
                <LabeledSelect label="State:" size="small" displayStyle="inline" options={issueStates} value={issueState} onChange={(value) => setIssueState(value)}></LabeledSelect>
              </div>
              <div className="filter">
                <LabeledSelect label="Type:" size="small" displayStyle="inline" options={issueTypes} value={issueFilter} onChange={(value) => setIssueType(value)}></LabeledSelect>
              </div>
            </div>
          </div>}
